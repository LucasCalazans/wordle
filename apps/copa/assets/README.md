...
|---|---|---|
| `icon.png` | 1024×1024 | Ícone iOS + fallback geral. Sem transparência (iOS rejeita). Pode ter o verde `#2E7D32` no fundo. |
...
- Gráfico de destaque: 1024×500 JPG/PNG (boa hora pra usar tema Copa: gramado + bola)
